...
{
    public class RavenDB_26698 : RavenTestBase
    {
        public RavenDB_26698(ITestOutputHelper output) : base(output)
        {
        }
        ...
        public async Task CanCompactDatabaseUsingTempPath()
        {
            ...
            }))
            {
                ...
                var oldSize = GetDirSize(new DirectoryInfo(path));
        ...
        private static void StoreAndDeleteBigAttachment(IDocumentStore store)
        {
        ...
        private static long GetDirSize(DirectoryInfo d)
        {
            ...
            size += d.GetDirectories().Sum(GetDirSize);

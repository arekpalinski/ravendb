...
namespace Raven.Server.ServerWide
{
    public class JsonDeserializationCluster : JsonDeserializationBase
    {
        ...
        public static Func<BlittableJsonReaderObject, ElasticEtlConfiguration> ElasticEtlConfiguration = GenerateJsonDeserializationRoutine<ElasticEtlConfiguration>();
        ...
        public static readonly Func<BlittableJsonReaderObject, ElasticConnectionString> ElasticConnectionString = GenerateJsonDeserializationRoutine<ElasticConnectionString>();
        ...
        public static readonly Dictionary<string, Func<BlittableJsonReaderObject, CommandBase>> Commands = new Dictionary<string, Func<BlittableJsonReaderObject, CommandBase>>
        {
            ...
            [nameof(AddElasticEtlCommand)] = GenerateJsonDeserializationRoutine<AddElasticEtlCommand>(),
            ...
            [nameof(PutElasticConnectionStringCommand)] = GenerateJsonDeserializationRoutine<PutElasticConnectionStringCommand>(),
            ...
            [nameof(RemoveElasticConnectionStringCommand)] = GenerateJsonDeserializationRoutine<RemoveElasticConnectionStringCommand>(),

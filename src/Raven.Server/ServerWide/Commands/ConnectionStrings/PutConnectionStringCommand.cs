...
namespace Raven.Server.ServerWide.Commands.ConnectionStrings
{
    ...
    public class PutElasticConnectionStringCommand : PutConnectionStringCommand<ElasticConnectionString>
    {
        protected PutElasticConnectionStringCommand()
        {
            // for deserialization
        }

        public PutElasticConnectionStringCommand(ElasticConnectionString connectionString, string databaseName, string uniqueRequestId) : base(connectionString, databaseName, uniqueRequestId)
        {
        ...
        public override void UpdateDatabaseRecord(DatabaseRecord record, long etag)
        {
            record.ElasticConnectionStrings[ConnectionString.Name] = ConnectionString;
        }
    }
}

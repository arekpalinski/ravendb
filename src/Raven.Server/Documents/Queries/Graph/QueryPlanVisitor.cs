...
namespace Raven.Server.Documents.Queries.Graph
{
    public class QueryPlanVisitor
    {
        ...
        public virtual Task VisitQueryQueryStepAsync(QueryQueryStep qqs)
        {
        ...
        public virtual Task VisitCollectionDestinationQueryStepAsync(CollectionDestinationQueryStep cdqs)
        {
            return Task.CompletedTask;
        }

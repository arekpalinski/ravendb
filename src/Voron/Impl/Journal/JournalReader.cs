...
namespace Voron.Impl.Journal
{
    public sealed unsafe class JournalReader
    {
        ...
        internal static List<long> ReadEncodedFreePage(byte* src, ByteStringContext allocator)
        {
            ...
            var sectionHeaders = (FreePagesSectionHeader*)(headerPtr + sizeof(FreePagesHeader));
            
            readPtr += sizeof(FreePagesHeader) + sizeof(FreePagesSectionHeader) * header.EncodedSectionsCount;

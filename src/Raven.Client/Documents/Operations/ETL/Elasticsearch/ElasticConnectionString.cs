...
{
    public class ElasticConnectionString : ConnectionString
    {
        public string[] Nodes;

        public override ConnectionStringType Type => ConnectionStringType.Elastic;
        ...
        {
            if (connectionString is ElasticConnectionString elasticConnection)
            {

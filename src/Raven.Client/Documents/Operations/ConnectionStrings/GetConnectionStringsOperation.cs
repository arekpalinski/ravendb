...
namespace Raven.Client.Documents.Operations.ConnectionStrings
{
    ...
    public class GetConnectionStringsResult
    {
        ...
        public Dictionary<string, ElasticConnectionString> ElasticConnectionStrings { get; set; }

        public DynamicJsonValue ToJson()
        {
            var ravenConnections = new DynamicJsonValue();
            var sqlConnections = new DynamicJsonValue();
            var elasticConnections = new DynamicJsonValue();
            ...
            foreach (var kvp in ElasticConnectionStrings)
            {
                elasticConnections[kvp.Key] = kvp.Value.ToJson();
            }
            ...
            return new DynamicJsonValue
            {
                ...
                [nameof(ElasticConnectionStrings)] = elasticConnections
            };
        }
    }
}

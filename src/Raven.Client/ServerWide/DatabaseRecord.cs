...
namespace Raven.Client.ServerWide
{
    ...
    public class DatabaseRecord
    {
        ...
        public Dictionary<string, ElasticConnectionString> ElasticConnectionStrings = new Dictionary<string, ElasticConnectionString>();
        ...
        public List<ElasticEtlConfiguration> ElasticEtls = new List<ElasticEtlConfiguration>();
